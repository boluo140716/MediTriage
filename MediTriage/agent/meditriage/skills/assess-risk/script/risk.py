...
# 高危单症状（任一出现 → high）。仅保留"确实需要立即重视"的词；
# 胸闷/气短/嗜睡/肢体麻木等普通场景也常见（焦虑/肠胃炎/久坐等），判 high
# 过严会让 Agent 评估大量误判为高危。这类主诉由 Agent 结合上下文评估 medium，
# 真风险仍由转诊危机词表（胸痛/呼吸困难/晕倒/卒中/自伤等）与 emergency 红旗兜底。
HIGH_RISK_SYMPTOMS = [
    "胸痛", "呼吸困难",
    "意识模糊",
    "剧烈头痛", "喷射性呕吐",
